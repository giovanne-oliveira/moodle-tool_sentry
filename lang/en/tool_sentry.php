...
$string['log_messages'] = "Enable custom logs";
$string['log_messages_desc'] = "Allow sending application log messages to Sentry with helper::log().";
$string['auto_hook'] = "Automatically forward PHP logs and add event breadcrumbs";
$string['auto_hook_desc'] = "When enabled, non-fatal PHP errors/notices are forwarded to Sentry and Moodle events are recorded as breadcrumbs for better context. Does not change Moodle's default error handling.";
...
$string['replay_heading_desc'] = "Configure sampling for Sentry Session Replay (Browser SDK). Requires the JavaScript loader to be set.";
$string['replays_session_sample_rate'] = "Replay Session Sample Rate";
$string['replays_session_sample_rate_desc'] = "0.0–1.0. Percentage of all user sessions to record. Recommended low (e.g., 0).";
$string['replays_on_error_sample_rate'] = "Replay On-Error Sample Rate";
$string['replays_on_error_sample_rate_desc'] = "0.0–1.0. Percentage of sessions to record when an error occurs. Recommended 1.0.";
